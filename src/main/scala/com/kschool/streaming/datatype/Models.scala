...
/**
  ...
  */
object Models {
  case class MeetupRSVGevent( member: Member,  response: String,  visibility: String, event: Event,
                              mtime: String, guests: String,  rsvp_id: String,  group: Group, venue: Venue)
  ...
  case class Group( group_name: String, group_city: String, group_lat: String, group_urlname: String, group_id: String,
                    group_country: String, group_lon: String, group_topics: List[Group_topics] )
